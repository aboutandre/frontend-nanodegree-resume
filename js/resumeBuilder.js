...
education.display = function() {
    ...
    for (var item in education.schools) {
        ...
        var schoolMajors = HTMLschoolMajor.replace("%data%", education.schools[item].majors);
        $(".education-entry:last").append(schoolName + schoolDegree + schoolDates + schoolLocation + "<br>" + schoolMajors + "<br>");
    }
    ...
    for (item in education.onlineCourses) {
        ...
        var onlineSchoolDates = HTMLonlineDates.replace("%data%", education.onlineCourses[item].dates);
...
projects.display = function() {
    for (var project in projects.project) {
        ...
        $(".project-entry:last").append(formattedProjTitle, formattedProjDate, formattedProjDescription);
